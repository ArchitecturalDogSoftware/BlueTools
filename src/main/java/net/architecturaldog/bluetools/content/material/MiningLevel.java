...
public record MiningLevel(Color color, List<Rule> rules) {
    ...
    public static final MapCodec<MiningLevel> CODEC = RecordCodecBuilder.mapCodec(instance -> {
        return instance
            .group(
    ...
    public sealed interface Rule permits BlockRule, TagRule {
        ...
        MapCodec<Rule> CODEC = Codec
            .mapEither(BlockRule.CODEC, TagRule.CODEC)
            .xmap(
    ...
    public record BlockRule(Block block, boolean inverted) implements Rule {
        ...
        public static final MapCodec<BlockRule> CODEC = RecordCodecBuilder.mapCodec(instance -> {
            return instance
                .group(
    ...
    public record TagRule(TagKey<Block> tagKey, boolean inverted) implements Rule {
        ...
        public static final MapCodec<TagRule> CODEC = RecordCodecBuilder.mapCodec(instance -> {
            return instance
                .group(

...
public record MaterialIngredient(
    Material material,
    MaterialIngredient.ItemType itemType,
...
)
{
    ...
    private DataResult<MaterialIngredient> validateCodecResult() {
    ...
    public sealed interface Ingredient permits ItemIngredient, TagIngredient {
        ...
        MapCodec<Ingredient> CODEC = Codec
            .mapEither(ItemIngredient.CODEC, TagIngredient.CODEC)
            .xmap(
    ...
    public record ItemIngredient(Item item) implements Ingredient {

        public static final MapCodec<ItemIngredient> CODEC = RecordCodecBuilder.mapCodec(instance -> {
            return instance
    ...
    public record TagIngredient(TagKey<Item> tagKey) implements Ingredient {
    ...
    public enum ItemType implements StringIdentifiable {
        ...
        public static final EnumCodec<ItemType> CODEC = StringIdentifiable.createCodec(ItemType::values);

        private final String key;
        private final boolean needsFluid;

        ItemType(final String key, final boolean needsFluid) {
            this.key = key;

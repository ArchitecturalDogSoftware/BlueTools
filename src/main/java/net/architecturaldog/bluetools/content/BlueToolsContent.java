...
public final class BlueToolsContent extends AutoLoader {
    ...
    // This needs to be loaded first so that values can be properly registered.
    ...
    public static final BlueToolsItemGroups ITEM_GROUPS = new BlueToolsItemGroups();
    ...
    public static final BlueToolsPartPropertyTypes PART_PROPERTY_TYPES = new BlueToolsPartPropertyTypes();
    public static final BlueToolsPartTypes PART_TYPES = new BlueToolsPartTypes();
    ...
    public static final BlueToolsToolPropertyTypes TOOL_PROPERTY_TYPES = new BlueToolsToolPropertyTypes();
    public static final BlueToolsToolTypes TOOL_TYPES = new BlueToolsToolTypes();

...
public final class BlueToolsBlockEntityTypes extends AutoLoader {
    ...
    private static <T extends BlockEntity> @NotNull RegistryLoad<BlockEntityType<T>> create(
    ...
    {
        return new RegistryLoad<>(identifier, Registries.BLOCK_ENTITY_TYPE, new BlockEntityType<>(factory, blocks));
    }
